...
parser.add_argument('--root_path', type=str, default='/data2/tcg/SLC-Net-main/data/ACDC', help='Name of Experiment')
parser.add_argument('--exp', type=str, default='MCNet_ours', help='experiment_name')
parser.add_argument('--model', type=str, default='mcnet2d_ours', help='model_name')
parser.add_argument('--num_classes', type=int,  default=4, help='output channel of network')
parser.add_argument('--labelnum', type=int, default=7, help='labeled data')
parser.add_argument('--gpu', type=str,  default='0', help='GPU to use')
parser.add_argument('--valroot_path', type=str, default='/data2/tcg/MC-Net-ours/model/MCNet_ours_all_cross_7_labeled/mcnet2d_ours', help='Name of Experiment')
...
def Inference(FLAGS,mod=None):
    ...
    net = net_factory(net_type='mcnet2d_ours', in_chns=1, class_num=FLAGS.num_classes)

    # 0.876 "/data2/tcg/MC-Net-ours/model/MACnet_ours_deep_7_labeled/mcnet2d_ours/iter_27400_dice_0.8592.pth"
