...
def var_all_case(model, num_classes, patch_size=(112, 112, 80), stride_xy=18, stride_z=4, dataset_name="LA"):
    if dataset_name == "LA":
        ...
        with open('/data2/tcg/MC-Net-ori/data/Pancreas/test_ours.list', 'r') as f:
            image_list = f.readlines()
        image_list = ["/data2/tcg/MC-Net-ori/data/Pancreas/Pancreas_h5/" + item.replace('\n', '') + "_norm.h5" for item in image_list]
...
def Pancreas_test_all_case(num_outputs, model, num_classes, patch_size=(112, 112, 80), stride_xy=18,
                  stride_z=4, save_result=True, test_save_path=None, preproc_fn=None, metric_detail=1, nms=0):
    with open('/data2/tcg/MC-Net-ori/data/Pancreas/val.list', 'r') as f:
    # with open('/data2/tcg/MC-Net-ori/data/Pancreas/test.list', 'r') as f:
    # with open('/data2/tcg/MC-Net-ori/data/Pancreas/test_ours.list', 'r') as f:
        image_list = f.readlines()
    image_list = ["/data2/tcg/MC-Net-ori/data/Pancreas/Pancreas_h5/" + item.replace('\n', '') + "_norm.h5" for item in image_list]
