...
parser.add_argument('--root_path', type=str, default='/data2/tcg/csf-net', help='Name of Dataset')
parser.add_argument('--exp', type=str,  default='exp', help='exp_name')
parser.add_argument('--model', type=str,  default='ours_net_3d', help='model_name')
parser.add_argument('--max_iteration', type=int,  default=15000, help='maximum iteration to train')
parser.add_argument('--max_samples', type=int,  default=58, help='maximum samples to train')
...
snapshot_path = "../model/Pancreas/{}_{}_labeled/{}".format(args.exp, args.labelnum, args.model)
...
if __name__ == "__main__":
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            loss = args.lamda * loss_seg_dice + consistency_weight * loss_consist #(loss_consist + consistency_loss1)
            optimizer.zero_grad()
            loss.backward()
            optimizer.step()
            ...
            if iter_num >= 800 and iter_num % 200 == 0:
                ...
                if args.dataset_name =="LA":
                    ...
                    # dice_sample = test_patch.test_all_case(model, num_classes=num_classes, patch_size=patch_size, stride_xy=16, stride_z=16, dataset_name = 'Pancreas_CT')

                    dice_sample = test_patch.Pancreas_test_all_case(model=model, num_outputs=1,num_classes=num_classes,
                                  patch_size=(96, 96, 96), stride_xy=16, stride_z=16,save_result=False,metric_detail=0, nms=0)
