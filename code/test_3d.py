...
parser.add_argument('--root_path', type=str, default='/data2/tcg/csf-net', help='Name of Experiment')
...
parser.add_argument('--labelnum', type=int, default=58, help='labeled data')
# parser.add_argument('--labelnum', type=int, default=7, help='labeled data')
parser.add_argument('--nms', type=int, default=0, help='apply NMS post-procssing?')

FLAGS = parser.parse_args()
os.environ['CUDA_VISIBLE_DEVICES'] = FLAGS.gpu
snapshot_path = '/data2/tcg/csf-net/' + "model/Pancreas/{}_{}_labeled/{}".format( FLAGS.exp, FLAGS.labelnum, FLAGS.model)
test_save_path = '/data2/tcg/csf-net/' + "model/Pancreas/{}_{}_labeled/{}_predictions/".format(FLAGS.exp, FLAGS.labelnum, FLAGS.model)
...
def test_calculate_metric():
    ...
    net = net_factory(net_type=FLAGS.model, in_chns=1, class_num=num_classes, mode="train")
